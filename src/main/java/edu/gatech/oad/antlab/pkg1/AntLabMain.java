 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  toPrint += p1.toString("jrosenfield3");
		  
                  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Jessica");
		  toPrint += p2.toString("jrosenfield3");
		  
                  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Jessica");
		  toPrint += p3.toString("jrosenfield3");
                  
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Jessica");
                  toPrint += p4.toString("jrosenfield3");
                  
                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Jessica");
                  toPrint += p5.toString("jrosenfield3");
                  
                  //Person6 replace P6 with your name
                  //and gburdell6 with your gt id
                  Person6 p6 = new Person6("Jessica");
                  toPrint += p6.toString("jrosenfield3");
