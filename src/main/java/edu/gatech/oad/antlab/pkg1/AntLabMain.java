 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  toPrint += p1.toString("mgeorge42");
		  
                  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Kenneth Adams");
		  toPrint += p2.toString("kadams44");
		  ...
		  toPrint += p3.toString("jrosenfield3");
                  ...
                  Person4 p4 = new Person4("Madeline Fox");
                  toPrint += p4.toString("mfox46");
                  
                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Charles Wang");
                  toPrint += p5.toString("cwang368");
